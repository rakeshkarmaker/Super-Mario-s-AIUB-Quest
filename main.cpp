...
void menu(){
    ...
    glVertex2f(400.0f, 535.0f);
    glVertex2f(900.0f, 535.0f);
    glVertex2f(900.0f, 483.0f);
    glEnd();
    ...
    drawText("!! SUPER MARIO's AIUB Conquest !!", 450, 500, GLUT_BITMAP_TIMES_ROMAN_24, 0.0f, 0.0f, 1.0f);
...
public:
    ...
    void draw() {
        glColor3f(0.0f, 0.0f, 1.0f); // Set character color to blue
...
void drawScoreboard(int characterX) {
    ...
    // int scoreboardY = 10; // Adjust this to appear below the character
    int scoreboardY = windowFinalY - 30;  // Position near the top
...
void sound()    {
    PlaySound("MarioAIUB.wav", NULL,SND_ASYNC|SND_FILENAME|SND_LOOP);
}
